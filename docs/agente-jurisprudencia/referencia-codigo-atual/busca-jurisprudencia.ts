...
// 22/08/2026 (supabase/functions/busca-jurisprudencia/index.ts), só pra
// contexto. Não é código vivo desta pasta — o original pode evoluir sem
// isso ser atualizado aqui.
//
