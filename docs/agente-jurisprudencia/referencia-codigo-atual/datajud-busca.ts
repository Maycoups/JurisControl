// SNAPSHOT DE REFERÊNCIA — copiado do repositório do JurisControl em
// 22/08/2026 (supabase/functions/datajud-busca/index.ts), só pra contexto
// (mapeamento de tribunais + uso da API pública do DataJud). Não é código
// vivo desta pasta — o original pode evoluir sem isso ser atualizado aqui.
//
